...
{
    public:
        TCrc32(const std::vector<uint8_t>& bytes);

        uint32_t getCrc32() { return mCrc32; };

    protected:
        uint32_t crc32c_sb8_64_bit(uint32_t crc, const unsigned char *p_buf, uint32_t length, uint32_t init_bytes);
        uint32_t multitable_crc32c(uint32_t crc32c, const unsigned char *buffer, unsigned int length);
    ...
    private:
        ...
        const uint32_t sctp_crc_tableil8_o32[256] =
        {
        ...
        const uint32_t sctp_crc_tableil8_o40[256] =
        {
        ...
        const uint32_t sctp_crc_tableil8_o48[256] =
        {
        ...
        const uint32_t sctp_crc_tableil8_o56[256] =
        {
        ...
        const uint32_t sctp_crc_tableil8_o64[256] =
        {
        ...
        const uint32_t sctp_crc_tableil8_o72[256] =
        {
        ...
        const uint32_t sctp_crc_tableil8_o80[256] =
        {
        ...
        const uint32_t sctp_crc_tableil8_o88[256] =
        {
